  ...
  return(
    <div>
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby='form-dialog-title'>
        ...
        <DialogContent>
          <DialogContentText>
            To reset your password, please enter your email address here to receive instructions on how to reset your password.
          </DialogContentText>
          <TextField 
          autoFocus
          margin='dense'
        ...
        <DialogActions>
          ...
          <Button onClick={handleSubmit} diasbled={isInvalid} type='submit' color='primary'>
            Reset Password
          </Button>
        </DialogActions>
      </Dialog>
